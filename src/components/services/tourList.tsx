  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3]">
        ...
        {tour.tag && (
          <span
            className={`absolute top-3 right-3 bg-orange-500 text-white text-xs rounded-md ${
  ...
  const tours: Tour[] = [
    {
      ...
      title: "Chương Trình Kỳ Úc Tuổi Thơ - Trải nghiệm làm...",
      tag: "Ưu đãi ",
      rating: 4.8,
      reviews: "(314)",
      price: 155000,
    },
    {
      ...
      title: "Trò Chơi Dân Gian Teambuilding tại Ông Đề",
      rating: 4.8,
      reviews: "(224)",
      price: 275000,
    },
    {
      ...
      title: "Chương Trình 'Tắt Mương Bắt Cá - Đậm Chất Miền Tây'",
      tag: "Ưu đãi ",
      rating: 4.7,
      reviews: "(968)",
      price: 288000,
    },
    {
      ...
      title: "Chương Trình Tham Quan 'Đặc Sắc' Tại Ông Đề",
      rating: 4.5,
      reviews: "(3,265)",
      price: 272000,
    },
    {
      ...
      title: "Chương Trình 'Đêm Trăng Tây Đô – Nghỉ Dưỡng'",
      tag: "Ưu đãi ",
      rating: 4.5,
      reviews: "(483)",
      price: 272000,
